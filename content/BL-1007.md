...
HeaderImage: https://res.cloudinary.com/dx2c2nxsx/image/upload/v1709615842/header_d17qqv.png
isPublished: true
---
...
![CAB](https://res.cloudinary.com/dx2c2nxsx/image/upload/v1709615923/cab_ykrajv.png)
...
![Async-Defer](https://res.cloudinary.com/dx2c2nxsx/image/upload/v1709615951/without-defer-async-head_f7j1mq.png)
...
![Async](https://res.cloudinary.com/dx2c2nxsx/image/upload/v1709615946/with-async_j3j2ui.png)

- Page loading With defer
  The script is fetched asynchronously, and it’s executed only after the HTML parsing is done.

![Defer](https://res.cloudinary.com/dx2c2nxsx/image/upload/v1709615948/with-defer_qpkfq2.png)
...
![eventflow](https://res.cloudinary.com/dx2c2nxsx/image/upload/v1709615941/eventflow_czkmbo.svg)
...
![event-order-bubbling](https://res.cloudinary.com/dx2c2nxsx/image/upload/v1709615944/event-order-bubbling_iwuj8t.svg)

## Event Capturing {#Event-Capturing}

**In event capturing, an event propagates from the outermost element to the target element.**

![event-order-capture](https://res.cloudinary.com/dx2c2nxsx/image/upload/v1709615938/capture_wfve9p.svg)
